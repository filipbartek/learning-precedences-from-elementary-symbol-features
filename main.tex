...
%\todo[author=Filip]{Email and url do not work.}
...
\todo[inline,author=Martin]{Remove URLs and DOIs.}
\todo[inline,author=CEURART]{Include: complete authors' names (namely full first names), title, year, volume, number, pages, DOI.}
