...
access to learning values for full precedences. Our idea for ``decomposing'' these values into pieces 
...
This is in more details explained in \autoref{sect:general}.
...
\paragraph{Second-level regression}
...
Note that at this moment, the preferences which were obtained as coefficient of linear regression
themselves become a regression target. In a certain sense, 
...
\paragraph{``Learning to order things''}
...
=======
\subsection{General preference matrix learning}  \label{sect:general}
>>>>>>> neco
...
\todo[author=Martin]{Kdyz bude cas, trochu rozepsat, aby lidi taky meli radost, ze existuje LtOT.}
