...
\conference{PAAR 2020: Seventh Workshop on Practical Aspects of Automated Reasoning, June 29--30, 2020 in Paris, France (virtual)}

\title{Learning Precedences from Simple Symbol Features}

\address[1]{Czech Technical University in Prague -- Czech Institute of Informatics, Robotics and Cybernetics.
Jugoslávských partyzánů 1580/3, 160 00 Praha 6 -- Dejvice, Czech Republic}
% https://www.ciirc.cvut.cz/about/ciirc-contact/
\address[2]{Czech Technical University in Prague -- Faculty of Electrical Engineering.
Technická 2, 166 27 Praha 6 -- Dejvice, Czech Republic}
% http://www.fel.cvut.cz/en/faculty/contact

\author[1,2]{Filip Bártek}[
%prefix=Mgr.,
%role=Researcher,
...
The system relies on machine learning to extract this information
from~past successful and unsuccessful runs of a theorem prover over a set of problems and randomly sampled precedences.
...
%\todo[author=Filip]{This sentence duplicates information given in section Performance measure. Shall we omit it?}
...
This is in more detail explained further below and, formally, in \Cref{sec:general-preference}.
...
% \todo[author=Filip]{I removed the dedicated "skolem" indicator because it is not included in the experiment because "introduced" suffices. Is this okay?}
...
We trained two types of general preference regressors (see \Cref{sec:general-preference}):
\begin{itemize}
...
%	runtime)?}
%\todo[inline,author=Filip]{I have not measured this.}
...
\begin{table*}
	...
	\begin{tabular}{l|rrrrr|rr}
		...
		% sftp://cluster.ciirc.cvut.cz/home/bartefil/git/vampire-ml/map-reduce/paar/6_final-refit/2020-05-14_00-41-46/reduce/4
