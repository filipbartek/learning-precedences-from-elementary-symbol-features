...
and \(\clauses\) is a set of first-order % quantifier-free 
...
The advantage of using abstract solving time is that it does not depend on the used hardware.}
...
\end{align*}
\todo[author=Filip]{Explain indicator.}
...
with random precedences represent an effectively infinite source of training data. 
...
% - zmin konkretni stratgie, kterou pouzivame a variu-eme v ni pouze predikatovou precendenci
