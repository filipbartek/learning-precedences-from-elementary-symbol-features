...
and to know preference values for pairs of symbols in the training set \ldots \todo{Martin: dokoncit vetu}
...
\begin{itemize}
	...
	\item \todo[inline]{jeste skolemovitost / tseitinovitost} \_introduced
	
	\todo{Kouknout, jestli tam vubec nejake tseitiny jsou (jestli ne, je to chyba)}
...
\todo{Martin: idealne pustit znovu bez problem embeddingu, at se o nem nemusime zminovat.}
